...
valor_global_J1 = None  
valor_global_J2 = None # Cambiada la variable a None para evitar errores en caso de que no se asignen valores en el bloque if
...
st.subheader("Predicción por Regresión Lineal")
